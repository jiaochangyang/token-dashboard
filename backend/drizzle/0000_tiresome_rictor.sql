...
--> statement-breakpoint
ALTER TABLE "deployments" ADD CONSTRAINT "deployments_token_contract_id_token_contracts_id_fk" FOREIGN KEY ("token_contract_id") REFERENCES "public"."token_contracts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
